...
// ----------------- LOGOUT API -----------------
export async function logoutUser(userId: number, stationId: number, sessionId: string, timeLeft: number) {
  return await apiFetch("/auth/client/logout", {
    method: "POST",
    body: JSON.stringify({ userId, stationId, sessionId, timeLeft }),
  });
}